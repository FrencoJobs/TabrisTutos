...
> <img align="left" src="file:///android_asset/www/src/images/note.png"> <i>The .tabrisignore file is only relevant for the build service. In a local build, you have to manage the packaged files yourself (see below).</i>
...
![Create an App](file:///android_asset/www/src/images/build-create-app.png)
...
![Valid App](file:///android_asset/www/src/images/build-valid-app.png)
...
> <img align="left" src="file:///android_asset/www/src/images/note.png"> <i>The build service installs the dependencies specified in your package.json from npm (except devDependencies). As a result, you don't have to put the `node_modules` folder under version control.</i>

> <img align="left" src="file:///android_asset/www/src/images/note.png"> <i>When building Windows apps, please also read the [Windows Support Documentation](windows-support.md)</i>

### Settings
![App Settings](file:///android_asset/www/src/images/build-app-settings.png)
